    ...
    <div className="mt-10">
      ...
      <div className="hero ">
        <div className="hero-content flex-col lg:flex-row">
          ...
          />
          <div>
            <h1 className="text-5xl font-bold" style={{ color: "#e0d2fe " }}>
      ...
      <div className="relative w-full flex gap-4 py-6   opacity-60 mt-20">
          <img
      ...
      <section className=" dark:text-gray-100 bg-transparent">
        <div className=" flex flex-col justify-center p-6 mx-auto sm:py-12 lg:py-24 lg:flex-row lg:justify-between">
          ...
          <div className="flex flex-col justify-center mr-72 p-6 text-center rounded-sm lg:max-w-md xl:max-w-lg lg:text-left">
            <h1 className="text-5xl font-bold sm:text-6xl dark:text-gray-800">
              Creating
        ...
        <div className="hero-content flex-col lg:flex-row">
          <div>
            <h1 className="text-5xl font-bold sm:text-6xl">
              The
              <span className="text-white">cinerama</span>
              <br />
